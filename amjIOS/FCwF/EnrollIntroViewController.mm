//
//  EnrollIntroViewController.m
//  amjIOS
//
//  Created by Hubino on 08/12/13.
//  Copyright (c) 2013 Kamal Mittal. All rights reserved.
//
...
@interface EnrollIntroViewController ()

@end

@implementation EnrollIntroViewController
